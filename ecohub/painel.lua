-- ecohub UI Library
-- Icons: Lucide (prefixo lucide-)

local function DestroyYep()
	for _ = 1, 10 do
		local g = game.CoreGui:FindFirstChild("ecohub_gui")
...
local Icons = {
	...
	["lucide-bolt"]         = "rbxassetid://10723345749",
	...
	["lucide-tool"]         = "rbxassetid://10747383470",
	...
	["lucide-rocket-2"]     = "rbxassetid://10734934585",
	["lucide-compass-2"]    = "rbxassetid://10709811445",
	["lucide-fingerprint"]  = "rbxassetid://10723375250",
	["lucide-scan"]         = "rbxassetid://10734942565",
	["lucide-qr-code"]      = "rbxassetid://10747360675",
	["lucide-barcode"]      = "rbxassetid://10747360675",
	["lucide-wand"]         = "rbxassetid://10747376565",
	["lucide-wand-2"]       = "rbxassetid://10747376349",
	["lucide-sparkles"]     = "rbxassetid://10709752035",
	["lucide-lightbulb"]    = "rbxassetid://10723425852",
	["lucide-bot"]          = "rbxassetid://10709782230",
	["lucide-cpu-2"]        = "rbxassetid://10709813383",
	["lucide-network"]      = "rbxassetid://10734906975",
	["lucide-satellite"]    = "rbxassetid://10734940825",
	...
	["lucide-flame-2"]      = "rbxassetid://10723376114",
	["lucide-bomb"]         = "rbxassetid://10709781460",
	["lucide-syringe"]      = "rbxassetid://10734975932",
	["lucide-stethoscope"]  = "rbxassetid://10734966384",
	["lucide-pill"]         = "rbxassetid://10734921935",
	["lucide-accessibility"] = "rbxassetid://10709751939",
	["lucide-magnet"]       = "rbxassetid://10723435069",
	["lucide-microscope"]   = "rbxassetid://10734889106",
	["lucide-beaker"]       = "rbxassetid://10709774756",
	["lucide-atom"]         = "rbxassetid://10709761813",
	...
	["lucide-badge"]        = "rbxassetid://10709769406",
...
-- ─── alias sem prefixo para facilitar uso ───────────────────
...
-- cria ImageLabel com icon Lucide
local function MkIcon(parent, name, sz, pos, col)
	...
	img.Position = pos or UDim2.new(0,6,0.5,-7)
...
local function BuildSection(sectionname, PageScroll)
	...
	function SecObj:addButton(name, callback, iconName)
		...
		local iconW = 0
		if iconName then
			local ic = MkIcon(f, iconName, UDim2.new(0,13,0,13), UDim2.new(0,8,0.5,-6.5), C.TEXT)
			if ic then iconW = 22 end
		end
		...
		if iconW > 0 then
			...
			pad.Parent = btn
			pad.PaddingLeft = UDim.new(0, iconW + 2)
		end
	...
	function SecObj:addToggle(togglename, default, callback, defaultKey, iconName)
		...
		-- icon opcional na frente do texto
		local iconOff = 0
		if iconName then
			local ic = MkIcon(f, iconName, UDim2.new(0,13,0,13), UDim2.new(0,28,0.5,-6.5), C.DIM)
		...
		Corner(ChkEdge,3) Stroke(ChkEdge, On and C.CHECK or C.BORDER)
		...
		Lbl.Size = UDim2.new(1, -(110 + iconOff), 1, 0)
		...
		KbBtn.TextSize = 9
		Corner(KbBtn,4) Stroke(KbBtn,C.BORDER)
		...
		HitBtn.MouseButton1Click:Connect(function()
			...
			On = not On UpdateVisuals() pcall(cb,On)
		end)
		...
		UserInputService.InputBegan:Connect(function(inp,gp)
			...
			if Listening then
				...
				if inp.KeyCode == Enum.KeyCode.Escape then
					ChosenKey = nil KbBtn.Text = "[ -- ]"
				else
					ChosenKey = inp.KeyCode KbBtn.Text = "["..GetKeyName(inp.KeyCode).."]"
				end
				KbBtn.TextColor3 = C.DIM
	...
	function SecObj:addSlider(name, mn, mx, def, callback, iconName)
		...
		if iconName then MkIcon(f, iconName, UDim2.new(0,12,0,12), UDim2.new(0,6,0,6), C.ACCENT) end

		local NL = Instance.new("TextLabel")
		NL.Parent = f NL.BackgroundTransparency = 1
		...
		Track.Parent = f Track.BackgroundColor3 = C.OFF Track.BorderSizePixel = 0
		Track.Position = UDim2.new(0,10,0,28) Track.Size = UDim2.new(1,-20,0,7)
		Track.AutoButtonColor = false Track.Text = ""
		Corner(Track,3)

		local Fill = Instance.new("Frame")
		Fill.Parent = Track Fill.BackgroundColor3 = C.ACCENT Fill.BorderSizePixel = 0
	...
	function SecObj:addTextBox(name, placeholder, callback, iconName)
		...
		if iconName then MkIcon(f, iconName, UDim2.new(0,12,0,12), UDim2.new(0,6,0.5,-6), C.DIM) end
		...
		Input.Parent = f Input.BackgroundColor3 = C.OFF Input.BorderSizePixel = 0
		Input.Position = UDim2.new(0.52,4,0.5,-9) Input.Size = UDim2.new(0.48,-14,0,18)
		Input.Font = Enum.Font.GothamSemibold
		Input.PlaceholderText = placeholder or "" Input.PlaceholderColor3 = C.DIM
		Input.Text = "" Input.TextColor3 = C.TEXT Input.TextSize = 10
	...
	function SecObj:addDropdown(name, list, callback, iconName)
		...
		Wrapper.Parent = SecContent Wrapper.BackgroundTransparency = 1
		Wrapper.BorderSizePixel = 0 Wrapper.Size = UDim2.new(1,0,0,28)
		Wrapper.ClipsDescendants = false

		local Hdr = Instance.new("Frame")
		Hdr.Parent = Wrapper Hdr.BackgroundColor3 = C.ELEM Hdr.BorderSizePixel = 0
		Hdr.Size = UDim2.new(1,0,0,28) Hdr.ZIndex = 5
		Corner(Hdr,5)

		if iconName then MkIcon(Hdr, iconName, UDim2.new(0,12,0,12), UDim2.new(0,6,0.5,-6), C.DIM) end

		local DN = Instance.new("TextLabel")
		DN.Parent = Hdr DN.BackgroundTransparency = 1
		...
		DS.Parent = Hdr DS.BackgroundTransparency = 1
		DS.Position = UDim2.new(0.58,0,0,0) DS.Size = UDim2.new(0.42,-26,1,0)
		DS.Font = Enum.Font.Gotham DS.Text = "none"
		DS.TextColor3 = C.DIM DS.TextSize = 10 DS.TextXAlignment = Enum.TextXAlignment.Right DS.ZIndex = 6

		local DA = Instance.new("TextLabel")
		DA.Parent = Hdr DA.BackgroundTransparency = 1
		DA.Position = UDim2.new(1,-22,0,0) DA.Size = UDim2.new(0,20,1,0)
		DA.Font = Enum.Font.GothamBold DA.Text = "v"
		DA.TextColor3 = C.ACCENT DA.TextSize = 10 DA.ZIndex = 6

		local DL = Instance.new("Frame")
		DL.Parent = Wrapper DL.BackgroundColor3 = C.SECT DL.BorderSizePixel = 0
		DL.Position = UDim2.new(0,0,0,30) DL.Size = UDim2.new(1,0,0,0)
		DL.ZIndex = 10 DL.ClipsDescendants = true DL.Visible = false
		Corner(DL,5) Stroke(DL)

		local DS2 = Instance.new("ScrollingFrame")
		DS2.Parent = DL DS2.BackgroundTransparency = 1 DS2.BorderSizePixel = 0
		DS2.Size = UDim2.new(1,0,1,0) DS2.ScrollBarThickness = 2
		DS2.ScrollBarImageColor3 = C.ACCENT DS2.ZIndex = 10
		DS2.CanvasSize = UDim2.new(0,0,0,0) DS2.AutomaticCanvasSize = Enum.AutomaticSize.Y
		...
		HB.Parent = Hdr HB.BackgroundTransparency = 1 HB.Size = UDim2.new(1,0,1,0)
		HB.Text = "" HB.AutoButtonColor = false HB.ZIndex = 7
		...
		for _,item in ipairs(list) do
			...
			Opt.Parent = DS2 Opt.BackgroundColor3 = C.ELEM Opt.BorderSizePixel = 0
			Opt.Size = UDim2.new(1,0,0,22) Opt.AutoButtonColor = false
			Opt.Font = Enum.Font.GothamSemibold Opt.Text = tostring(item)
			Opt.TextColor3 = C.TEXT Opt.TextSize = 10 Opt.ZIndex = 11
			Corner(Opt,4)
			...
			Opt.MouseButton1Click:Connect(function()
				...
				CloseDD() pcall(cb,item)
			end)
		end

		local ctrl = {}
		function ctrl:Set(v) Selected=v DS.Text=tostring(v) DS.TextColor3=C.ACCENT end
	...
	function SecObj:addKeybind(name, default, callback)
		local cb = callback or function() end
		local CK = default or nil local Listening = false
		local f = Base(28)
		...
		local KbBtn = Instance.new("TextButton")
		KbBtn.Parent = f KbBtn.BackgroundColor3 = C.KEYBG KbBtn.BorderSizePixel = 0
		KbBtn.AnchorPoint = Vector2.new(1,0.5) KbBtn.Position = UDim2.new(1,-6,0.5,0)
		KbBtn.Size = UDim2.new(0,64,0,18) KbBtn.AutoButtonColor = false
		KbBtn.Font = Enum.Font.GothamSemibold
		KbBtn.Text = CK and "["..GetKeyName(CK).."]" or "[NONE]"
		KbBtn.TextColor3 = C.DIM KbBtn.TextSize = 9
		Corner(KbBtn,4) Stroke(KbBtn)
	...
	function SecObj:addColorPicker(name, default, callback)
		...
		MkIcon(Hdr, "palette", UDim2.new(0,12,0,12), UDim2.new(0,6,0.5,-6), C.DIM)

		local NL = Instance.new("TextLabel")
		NL.Parent = Hdr NL.BackgroundTransparency = 1
		NL.Position = UDim2.new(0,22,0,0) NL.Size = UDim2.new(0.6,0,1,0)
		...
		HexL.Parent = Hdr HexL.BackgroundTransparency = 1
		...
		Prev.Parent = Hdr Prev.BackgroundColor3 = CurColor Prev.BorderSizePixel = 0
		Prev.Position = UDim2.new(1,-30,0.5,-7) Prev.Size = UDim2.new(0,14,0,14)
		Corner(Prev,3) Stroke(Prev)

		local Panel = Instance.new("Frame")
		Panel.Parent = Wrapper Panel.BackgroundColor3 = C.SECT Panel.BorderSizePixel = 0
		Panel.Position = UDim2.new(0,0,0,30) Panel.Size = UDim2.new(1,0,0,0)
		Panel.ClipsDescendants = true Panel.Visible = false
		Corner(Panel,5) Stroke(Panel)

		local function Refresh()
			CurColor = Color3.fromHSV(H,S,V)
			Prev.BackgroundColor3 = CurColor HexL.Text = ToHex(CurColor) pcall(cb,CurColor)
		end
		...
		for i,ch in ipairs(chs) do
			...
			RL.Parent = Row RL.BackgroundTransparency = 1 RL.Size = UDim2.new(0,14,1,0)
			RL.Font = Enum.Font.GothamBold RL.Text = ch.l RL.TextColor3 = C.ACCENT RL.TextSize = 10

			local RT = Instance.new("TextButton")
			RT.Parent = Row RT.BackgroundColor3 = C.OFF RT.BorderSizePixel = 0
			RT.Position = UDim2.new(0,20,0.5,-3) RT.Size = UDim2.new(1,-60,0,6)
			RT.AutoButtonColor = false RT.Text = ""
			Corner(RT,3)

			local RF = Instance.new("Frame")
			RF.Parent = RT RF.BackgroundColor3 = C.ACCENT RF.BorderSizePixel = 0
			RF.Size = UDim2.new(ch.g(),0,1,0)
			Corner(RF,3)

			local RV = Instance.new("TextLabel")
			RV.Parent = Row RV.BackgroundTransparency = 1
		...
		HB.MouseButton1Click:Connect(function()
			...
			if Open then
				...
				task.delay(0.14,function() Panel.Visible=false Wrapper.Size=UDim2.new(1,0,0,28) end)
			end
		end)
...
function Library:CreateWindow(windowname, windowinfo)
	...
	Main.Name = "Main" Main.Parent = ScreenGui
	Main.BackgroundColor3 = C.BG Main.BorderSizePixel = 0
	Main.Position = UDim2.new(0.25,0,0.25,0) Main.Size = UDim2.new(0,520,0,340)
	Main.ClipsDescendants = true
	Corner(Main,8) Stroke(Main)

	local TitleBar = Instance.new("Frame")
	TitleBar.Parent = Main TitleBar.BackgroundColor3 = C.SIDEBAR
	TitleBar.BorderSizePixel = 0 TitleBar.Size = UDim2.new(1,0,0,32)
	Corner(TitleBar,8)

	local TitleFix = Instance.new("Frame")
	TitleFix.Parent = TitleBar TitleFix.BackgroundColor3 = C.SIDEBAR
	TitleFix.BorderSizePixel = 0 TitleFix.Position = UDim2.new(0,0,0.5,0) TitleFix.Size = UDim2.new(1,0,0.5,0)

	local TitleLabel = Instance.new("TextLabel")
	TitleLabel.Parent = TitleBar TitleLabel.BackgroundTransparency = 1
	TitleLabel.Position = UDim2.new(0,12,0,0) TitleLabel.Size = UDim2.new(0.6,0,1,0)
	TitleLabel.Font = Enum.Font.GothamBold TitleLabel.Text = windowname or "ecohub"
	TitleLabel.TextColor3 = C.TEXT TitleLabel.TextSize = 12 TitleLabel.TextXAlignment = Enum.TextXAlignment.Left

	local VerLabel = Instance.new("TextLabel")
	VerLabel.Parent = TitleBar VerLabel.BackgroundTransparency = 1
	VerLabel.Position = UDim2.new(0,0,0,0) VerLabel.Size = UDim2.new(1,-12,1,0)
	VerLabel.Font = Enum.Font.Gotham VerLabel.Text = windowinfo or "v1.0"
	VerLabel.TextColor3 = C.DIM VerLabel.TextSize = 10 VerLabel.TextXAlignment = Enum.TextXAlignment.Right

	local Body = Instance.new("Frame")
	Body.Name = "Body" Body.Parent = Main Body.BackgroundTransparency = 1
	Body.BorderSizePixel = 0 Body.Position = UDim2.new(0,0,0,32) Body.Size = UDim2.new(1,0,1,-32)

	local Sidebar = Instance.new("Frame")
	Sidebar.Parent = Body Sidebar.BackgroundColor3 = C.SIDEBAR Sidebar.BorderSizePixel = 0
	Sidebar.Size = UDim2.new(0,120,1,0)
	Corner(Sidebar,8)

	local SidebarFix = Instance.new("Frame")
	SidebarFix.Parent = Sidebar SidebarFix.BackgroundColor3 = C.SIDEBAR SidebarFix.BorderSizePixel = 0
	SidebarFix.Position = UDim2.new(1,-8,0,0) SidebarFix.Size = UDim2.new(0,8,1,0)

	local TabScroll = Instance.new("ScrollingFrame")
	TabScroll.Parent = Sidebar TabScroll.BackgroundTransparency = 1 TabScroll.BorderSizePixel = 0
	TabScroll.Position = UDim2.new(0,6,0,6) TabScroll.Size = UDim2.new(1,-12,1,-12)
	TabScroll.ScrollBarThickness = 2 TabScroll.ScrollBarImageColor3 = C.ACCENT
	TabScroll.CanvasSize = UDim2.new(0,0,0,0) TabScroll.AutomaticCanvasSize = Enum.AutomaticSize.Y

	local TabLayout = Instance.new("UIListLayout")
	TabLayout.Parent = TabScroll TabLayout.SortOrder = Enum.SortOrder.LayoutOrder TabLayout.Padding = UDim.new(0,3)

	local ContentArea = Instance.new("Frame")
	ContentArea.Parent = Body ContentArea.BackgroundTransparency = 1 ContentArea.BorderSizePixel = 0
	ContentArea.Position = UDim2.new(0,126,0,4) ContentArea.Size = UDim2.new(1,-130,1,-8)
	...
	TitleBar.InputBegan:Connect(function(inp)
		...
		if inp.UserInputType==Enum.UserInputType.MouseButton2 then
			-- RMB toggle minimize handled below
		end
	end)
	...
	local FullH=UDim2.new(0,520,0,340) local MiniH=UDim2.new(0,520,0,32)
	local function DoMinimize(hide)
		Minimized=hide
		if hide then Tw(Main,{Size=MiniH},TI.Slow) Tw(Body,{Position=UDim2.new(0,0,1.2,0)},TI.Med)
		else Tw(Main,{Size=FullH},TI.Slow) Tw(Body,{Position=UDim2.new(0,0,0,32)},TI.Med) end
	end
	TitleBar.InputBegan:Connect(function(inp)
		if inp.UserInputType==Enum.UserInputType.MouseButton2 then DoMinimize(not Minimized) end
	end)
	UserInputService.InputBegan:Connect(function(inp,gp)
	...
	function Window:addPage(pagename, iconName)
		local hasIcon = iconName and GetIcon(iconName) ~= nil
		local iconSize = 14

		local Tab = Instance.new("TextButton")
		Tab.Parent = TabScroll Tab.BackgroundColor3 = C.ELEM Tab.BackgroundTransparency = 1
		Tab.BorderSizePixel = 0 Tab.Size = UDim2.new(1,0,0,28) Tab.AutoButtonColor = false
		Tab.Font = Enum.Font.GothamSemibold Tab.TextColor3 = C.DIM Tab.TextSize = 11
		Tab.Text = "" -- always use children
		Corner(Tab,5)
		...
		if hasIcon then
			...
			TabIcon.Position = UDim2.new(0,6,0.5,-iconSize/2)
		...
		TabLbl.Position = hasIcon and UDim2.new(0,6+iconSize+4,0,0) or UDim2.new(0,8,0,0)
		TabLbl.Size = hasIcon and UDim2.new(1,-(6+iconSize+4+4),1,0) or UDim2.new(1,-16,1,0)
		TabLbl.Font = Enum.Font.GothamSemibold TabLbl.Text = pagename
		TabLbl.TextColor3 = C.DIM TabLbl.TextSize = 11 TabLbl.TextXAlignment = Enum.TextXAlignment.Left
		TabLbl.Name = "TabLabel" TabLbl.Parent = Tab

		local Underline = Instance.new("Frame")
		Underline.Parent = Tab Underline.BackgroundColor3 = C.ACCENT Underline.BorderSizePixel = 0
		Underline.AnchorPoint = Vector2.new(0.5,1) Underline.Position = UDim2.new(0.5,0,1,-1)
		Underline.Size = UDim2.new(0,0,0,1) Underline.Visible = false
		Corner(Underline,1)

		local PageFrame = Instance.new("Frame")
		PageFrame.Parent = ContentArea PageFrame.BackgroundTransparency = 1
		PageFrame.BorderSizePixel = 0 PageFrame.Size = UDim2.new(1,0,1,0) PageFrame.Visible = false

		local PageScroll = Instance.new("ScrollingFrame")
		PageScroll.Parent = PageFrame PageScroll.BackgroundTransparency = 1 PageScroll.BorderSizePixel = 0
		PageScroll.Size = UDim2.new(1,0,1,0) PageScroll.ScrollBarThickness = 2
		PageScroll.ScrollBarImageColor3 = C.ACCENT PageScroll.CanvasSize = UDim2.new(0,0,0,0)
		PageScroll.AutomaticCanvasSize = Enum.AutomaticSize.Y

		local PL = Instance.new("UIListLayout") PL.Parent = PageScroll PL.SortOrder = Enum.SortOrder.LayoutOrder PL.Padding = UDim.new(0,5)
		local PP = Instance.new("UIPadding") PP.Parent = PageScroll
		PP.PaddingTop=UDim.new(0,2) PP.PaddingBottom=UDim.new(0,6) PP.PaddingRight=UDim.new(0,2)
		...
		table.insert(Pages,{Tab=Tab,Page=PageFrame,Underline=Underline,SetColor=SetTabColor})
		...
		local function SelectTab()
			...
			SetTabColor(C.TEXT)
			Underline.Visible=true Underline.Size=UDim2.new(0,0,0,1)
		...
		Tab.MouseEnter:Connect(function() if ActiveTab~=Tab then Tw(Tab,{BackgroundTransparency=0,BackgroundColor3=C.HOVER},TI.Fast) end end)
		Tab.MouseLeave:Connect(function() if ActiveTab~=Tab then Tw(Tab,{BackgroundTransparency=1},TI.Fast) end end)

		if #Pages==1 then SelectTab() end

		local PageObj = {}
		function PageObj:addSection(sname)
			return BuildSection(sname, PageScroll)
		end
		return PageObj
	end
